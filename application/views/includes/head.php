		...
		<div class='container-fluid'>
			...
			<div class='collapse navbar-collapse' id='topFixedNavbar1'>	
				<ul class='nav navbar-nav'>
					...
					<li><a href="<?php echo base_url('index.php/Create_controller')?>" aria-haspopup='true' aria-expanded='false'>Create</a></li>
					<li class='dropdown'>
					...
					<li class='dropdown'>
						<a href='#' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>Superuser<span class='caret'></span></a>
							<ul class='dropdown-menu'>
										<li><a href="<?php echo base_url('index.php/ViewEdit_controller')?>">Update User</a></li>
										
										<li><a href="<?php echo base_url('index.php/ViewUpgrade_controller')?>">Upgrade User</a></li>
										<li><a href="<?php echo base_url('index.php/ViewDowngrade')?>">Downgrade User</a></li>
										<li><a href="<?php echo base_url('index.php/ViewDelete_controller')?>">Delete User</a></li>
